...
const MANUAL_ARGUMENT_HINT = new Set(["00-backlog", "01-brainstorm", "02-project-memory", "02-user-stories", "04-skill-generate", "05-spike", "06-product-brief", "07-epic", "09-defect", "10-task"]);
