...
> Not part of the hexagonal-refactor pass (phases 1-6). This is the "second temps" improvement:
> give the ink view the same live refresh the web view already has, behind an explicit flag.
> Run this phase only after phases 1-6 are `done` and the hexagon holds.
