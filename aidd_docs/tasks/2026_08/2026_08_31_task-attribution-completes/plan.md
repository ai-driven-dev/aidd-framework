...
| A capture is preferred to a derivation only where the tool can actually be run               | Codex can now be run, so its derivation goes. Nothing else in the set is derived while its tool is runnable — that is the standard, not "no derivations ever".                                                                                                                                                                                                                    |
