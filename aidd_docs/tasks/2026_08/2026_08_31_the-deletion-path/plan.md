...
| History is reported at two strengths, not one                                                  | `listTrackedFiles` answers what is tracked now. Tracked now is certainly in history; not tracked now may still be in history and cannot be told apart from never committed. Reporting the weaker case as an all-clear would be the false-certainty fault this branch has paid for five times. |
