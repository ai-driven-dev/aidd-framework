...
- [ ] Removing a plugin leaves every user-authored key in the settings file intact
- [ ] An unrecognized capability shape raises a typed error, not a silent fallthrough
- [ ] Removal is idempotent: running it twice changes nothing the second time
