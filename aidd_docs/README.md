...
| aidd-pm           | Product management: ticket info, user stories, discovery, PRD, spec, spikes          | `01-ticket-info`, `02-user-stories`, `03-discovery`, `04-prd`, `05-spec`, `06-spike` |
...
| aidd-pm      | 01-ticket-info, 02-user-stories, 03-discovery, 04-prd, 05-spec, 06-spike                                           |
...
3. **Frame the request**: `aidd-refine:01-brainstorm` to clarify, `aidd-pm:03-discovery` to frame a product, then `aidd-pm:02-user-stories`, `aidd-pm:04-prd`, or `aidd-pm:05-spec` to formalize scope.
