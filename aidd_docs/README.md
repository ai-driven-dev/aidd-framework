...
| aidd-pm           | Backlog artifacts, refinement, Product Briefs, Epics, User Stories, Tasks, Spikes, Defects, requirements, and specs | `02-user-stories`, `05-spike`, `07-epic`, `08-three-amigos`, `09-defect`, `10-task` |
...
| aidd-orchestrator | Async development and product backlog orchestration                                | `00-async-dev`, `02-backlog`                                |
