...
- A dual-mode skill (interactive by default, unattended on request, e.g. `aidd-orchestrator:01-sdlc`) runs the other way when the user asks and the skill supports it.
