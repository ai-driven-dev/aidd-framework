...
| `-` | [SKILL.md](skills/01-commit/SKILL.md) | `Create atomic conventional commits, safely repair scoped hook failures, and optionally push. Use when the user wants to commit changes, optionally pushing the branch. Not for amending, rebasing, opening a pull request, or tagging a release.` |
