...
First time? Install with `/plugin install aidd-pm@aidd-framework`, then run `aidd-pm:00-backlog`.

Covers backlog intake, refinement, review, lifecycle, Product Briefs, Epics, User Stories, Tasks, Spikes, Defects, requirements, and specs.

## Skills

| Bracket ID | Skill | Description |
|---|---|---|
| [4.0] | [backlog](skills/00-backlog/SKILL.md) | Orchestrate backlog events and verify the resulting graph. |
