...
3. Inspect secrets, injection sinks, unsafe deserialization, CORS/TLS/security defaults, and destructive operations where relevant. Cite a secret's location and kind, never its value.
