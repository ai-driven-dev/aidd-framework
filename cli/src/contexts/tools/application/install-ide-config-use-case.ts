...
import type { PostInstallPipelineUseCase } from "../../../application/use-cases/install/post-install-pipeline-use-case.js";
...
import { getToolConfig } from "../domain/registry.js";
import type { SettingsCapability } from "../domain/settings-capability.js";
