...
const BASELINE = [
  ...
  "src/domain/formats/codex-marketplace.ts",
  "src/domain/formats/copilot-marketplace.ts",
  "src/domain/formats/cursor-hooks.ts",
  "src/domain/formats/cursor-marketplace.ts",
  "src/domain/formats/opencode-marketplace.ts",
  "src/domain/models/framework-build.ts",
  "src/domain/models/framework.ts",
  "src/domain/models/manifest.ts",
  "src/domain/models/normalized-plugin.ts",
