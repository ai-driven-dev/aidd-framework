...
import { InvalidReportDayError, InvalidReportSpanError } from "../../../src/domain/errors.js";
import {
  DEFAULT_REPORT_DAYS,
  resolveReportPeriod,
} from "../../../src/domain/models/report-period.js";
...
describe("resolveReportPeriod", () => {
  ...
  it("reads no clock of its own", () => {
    const source = readFileSync(
      fileURLToPath(new URL("../../../src/domain/models/report-period.ts", import.meta.url)),
      "utf8"
    );
