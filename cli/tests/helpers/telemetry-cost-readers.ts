 ...
 * without the `aidd` package — see `plugins/aidd-telemetry/skills/01-cost/scripts/lib/readers.cjs`,
 * shared as-is between the cost and check skills. Tests reach it here rather than
...
export const telemetryCostReaders: TelemetryCostReadersModule = createRequire(import.meta.url)(
  "../../../plugins/aidd-telemetry/skills/01-cost/scripts/lib/readers.cjs"
);
